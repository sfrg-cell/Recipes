...
from api.models import Recipe, Category, Cuisine, Complexity, Ingredient, MeasurementUnit
...
class RecipeFilterTests(TestCase):
    def setUp(self):
        ...
        self.complexity_medium = Complexity.objects.create(name='Medium')
        self.complexity_hard = Complexity.objects.create(name='Hard')
        
        self.unit = MeasurementUnit.objects.create(name='grams')
        self.ingredient_flour = Ingredient.objects.create(name='Flour', unit=self.unit)
        self.ingredient_sugar = Ingredient.objects.create(name='Sugar', unit=self.unit)
    ...
    def test_filter_by_category(self):
        ...
        self.assertEqual(results.first().title, 'Chocolate Cake')
    ...
    def test_filter_by_cuisine(self):
        ...
        self.assertEqual(results[1].title, 'Pasta Carbonara')
    ...
    def test_filter_by_cooking_time_max(self):
        ...
        results = filter_set.qs
        self.assertEqual(results.count(), 1)
        self.assertEqual(results.first().title, 'Pasta Carbonara')
